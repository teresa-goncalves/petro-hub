...
const MAX_POR_FONTE = 3;  // para nenhuma fonte dominar a lista
...
// Teto por fonte: a que publica mais tomava a seção inteira (a CleanTechnica ficou com
// 6 das 9 vagas na primeira rodada). Como já está ordenado, cada fonte entrega as suas
// mais recentes e as outras continuam cabendo.
const porFonte = {};
itens = itens.filter(n => {
  porFonte[n.src] = (porFonte[n.src] || 0) + 1;
  return porFonte[n.src] <= MAX_POR_FONTE;
});
